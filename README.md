...
The app deliberately puts the business rules on the backend: exact-cent splitting, balance calculation, debt simplification, settlement validation, household isolation, persistence, and paginated expense retrieval. Spring Boot provides a clean REST/service/repository structure and JPA/Hibernate persistence.
...
- Live balances and simplified “who owes whom” suggestions
...
- Unit tests for split and debt-simplification math
